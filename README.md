...
5. [**next**] A-B wide binary orbit fit with astrometric dataset and RV information from Keck double-lined solution. Constrains the above astrometric parameters plus `K_A`, `K_B`, `gamma_AB`$. Alternatively, add in the stellar masses.

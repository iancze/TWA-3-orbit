...
plotdir = "figures/close/rv_astro_disk_more/"

if not os.path.isdir(plotdir):
    os.makedirs(plotdir)

trace = pm.load_trace(directory="chains/close/rv_astro_disk_more", model=m.model)
...
samples["Omega"] /= deg
samples["iDisk"] /= deg 
samples["OmegaDisk"] /= deg
samples["thetaADisk"] /= deg
